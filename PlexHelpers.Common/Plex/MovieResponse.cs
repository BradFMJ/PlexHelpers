...
namespace PlexHelpers.Common.Plex
{
    ...
    public class MovieResponse
    {
        ...
        {
            MediaContainer = new MovieResponseMediaContainer();
        }

        [DataMember(Name = "MediaContainer")]
        public MovieResponseMediaContainer MediaContainer { get; set; }
    }

    [DataContract]
    public class MovieResponseMediaContainer
    {
        public MovieResponseMediaContainer()
        {
            Metadata = new List<MovieResponseItem>();
        }
        ...
        public List<MovieResponseItem> Metadata { get; set; }
    }

    [DataContract]
    public class MovieResponseItem
    {
        public MovieResponseItem()
        {
            Collections = new List<MovieResponseItemCollection>();
        }
        ...
        public List<MovieResponseItemCollection> Collections { get; set; }
    }

    [DataContract]
    public class MovieResponseItemCollection
    {
        [DataMember(Name = "id")]
